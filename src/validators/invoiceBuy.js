...
const validateCreate = [
  check("number").exists().isInt().notEmpty(),
  check("id_supplier").exists().isString().notEmpty(),
  check("id_employee").exists().isString().notEmpty(),
  check("products").exists().isArray().notEmpty(),
  check("products.*.id_product").exists().isString().notEmpty(),
  check("products.*.quantity").exists().isFloat().notEmpty(),
  check("products.*.price_total").exists().isFloat().notEmpty(),
  check("price_sub")
    .exists()
    .isFloat()
    .custom((value, { req }) => {
    ...
    .notEmpty(),
  check("price_porcent").exists().isFloat().notEmpty(),
  check("price_iva").exists().isFloat().notEmpty(),
  check("price_total")
    .exists()
    .isFloat()
    .custom((value, { req }) => {
  ...
  check("date")
    ...
    .notEmpty(),
  check("credit").exists().isBoolean().notEmpty(),
  check("amount_pay")
    .exists()
    .isFloat()
    .custom((value, { req }) => {
...
const validateCreateReturn = [
  ...
  check("products").exists().isArray().notEmpty(),
  check("products.*.id_product").exists().isString().notEmpty(),
  check("products.*.id_invoice").exists().isString().notEmpty(),
  check("products.*.quantity").exists().isFloat().notEmpty(),
  check("products.*.price_total").exists().isFloat().notEmpty(),
  check("price_sub")
    .exists()
...
const validateUpdate = [
  check("date")
    ...
    .notEmpty(),
  check("amount_pay").exists().isFloat().notEmpty(),
  check("amount_paid").exists().isFloat().notEmpty(),
  check("amount_remaining").exists().isFloat().notEmpty(),
  (req, res, next) => {
    validateResult(req, res, next);
  },
];

module.exports = { validateCreate, validateCreateReturn, validateUpdate };
